...
Once have a look at my website:
👇👇👇👇👇
https://twogoodco-clone-madebyvinay.netlify.app/

Tools required:
1. Any text editor compatible with HTML, CSS, and JavaScript (VS code preferable).
2. For deployment I have used netlify because it is free of cost.
